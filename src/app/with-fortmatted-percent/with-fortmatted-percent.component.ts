...
@Component({
  selector: 'app-with-fortmatted-percent',
  templateUrl: './with-fortmatted-percent.component.html',
  styleUrls: ['./with-fortmatted-percent.component.css']
})
export class WithFortmattedPercentComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit {
  filters: any[];
